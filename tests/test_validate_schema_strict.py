...
VALID_SAMPLES = {
    ...
    "chart-spec.schema.json": {
        ...
        "title": "结果证据概览",
        "option": {"xAxis": [{"type": "value", "minInterval": 1}]},
        "summary_text": "按结果类型聚合的证据方向",
        "integrity": {"numbers_match_result": "NOT_CHECKED",
...
def _make_evidence(study_id, sample_id, direction="support", quality=8.0,
    ...
    return {
        ...
        "study_id": study_id,
        "sample_id": sample_id,
        "claim_id": f"C-{study_id}",
        "claim": "claim",
        "outcome_type": "retention",
        "direction": direction,
        "relation_to_claim": direction,
        "effect_direction": {"support": "positive", "contradict": "negative"}.get(direction, "null"),
        "decision_relation": {"support": "support_adoption", "contradict": "oppose_adoption"}.get(direction, "neutral"),
